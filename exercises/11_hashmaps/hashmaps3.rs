...
fn build_scores_table(results: &str) -> HashMap<&str, TeamScores> {
    ...
    for line in results.lines() {
        ...
        // ADDED: added team entries if they don't exist.

        // Insert the team if it doesn't exist.
        scores.entry(team_1_name).or_insert(TeamScores::default());
        scores.entry(team_2_name).or_insert(TeamScores::default());

        // ADDED: update the scores for the teams.
        // Update the scores.
